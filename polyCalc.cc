...

{
	...
	cout << "?: Allows entry of a polynomial.  " << endl
             << "   Each term of the polynomial is specified by two integers." << endl
	     << "   The first integer specifies the coefficient and " << endl
	     << "   the second specifies the degree of the term." << endl;
  ...
  switch (command) {
   ...
   case 'e':
       ...
       if (stored_polynomials.empty( )) {
           ...
           stored_polynomials.top(p);
           cout << "Please enter a value you wish to evaluate the Polynomial at" << endl;
           cin >> value;
           cout << p.evaluate(value) << endl;
       } //end inner if-else    
      break;
    case 'q':
